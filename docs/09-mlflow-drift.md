...
Збирає й пушить три образи з `apps/`: **`mds06-mlflow-tools:v5`**,
...
Один образ `mds06-mlflow-tools:v5` на три задачі:
...
apps/                    код і Dockerfile
  trainer/
    ...
    Dockerfile               КОНТРАКТНИЙ образ mds06-mlflow-tools:v5 (обидва скрипти),
