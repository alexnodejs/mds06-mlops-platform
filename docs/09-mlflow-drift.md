...
Збирає й пушить три образи з `apps/`: **`mds06-mlflow-tools:v8`**,
...
Один образ `mds06-mlflow-tools:v8` на три задачі:
...
apps/                    код і Dockerfile
  trainer/
    ...
    Dockerfile               КОНТРАКТНИЙ образ mds06-mlflow-tools:v8 (обидва скрипти),
